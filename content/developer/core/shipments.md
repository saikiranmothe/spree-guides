...
Zones serve as a mechanism for grouping geographic areas together into a single entity. The Shipping Address entered during checkout will define the zone the customer is in and limit the Shipping Methods available to him.
